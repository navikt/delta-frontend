...
export default async function RootLayout({ children }: RootLayoutProps) {
    return (
        ...
        <head>
            ...
            <script defer src="https://cdn.nav.no/team-researchops/sporing/umamisporing.js"
                    data-host-url="https://umamiproxy.nav.no"
                    data-website-id="d63b28b5-31d9-44e8-a91d-6ca06d472a04"></script>
        </head>
        <body>
