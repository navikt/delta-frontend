...
import EventList from "@/components/fagdag_utvikling_og_data/views/eventList";
import EventProgramOverview from "@/components/fagdag_utvikling_og_data/views/eventProgramOverview";
...
const fagfestivalCategory = "fagdag_utvikling_og_data";
const activeDays = ["6"];
